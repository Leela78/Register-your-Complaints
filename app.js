...
async function checkAuthStatus() {
    try {
        const response = await fetch('https://example.com/api/check-auth');
...
async function loadComplaints() {
    ...
    try {
        ...
        let url = 'https://example.com/api/complaints?';
...
async function confirmStatusUpdate(complaintId) {
    ...
    try {
        const response = await fetch(`https://example.com/api/complaints/${complaintId}/resolve`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
...
async function searchPreviousComplaints() {
    ...
    try {
        const response = await fetch(`https://example.com/api/complaints/search?email=${encodeURIComponent(email)}`);
        const data = await response.json();
